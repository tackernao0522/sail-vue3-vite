...
## 98. vue-charts-3 インストール

### Charts.jsのVue.js3用ラッパー

+ https://vue-chart-3.netlify.app/ <br>

+ https://www.chartjs.org/docs/latest/ <br>

+ `$ npm i vue-chart-3@3.1.8 chart.js@3.9.1`を実行<br>

+ [参考](https://zenn.dev/sa2knight/scraps/1ec7a24b9a36ba) <br>

+ `$ touch resources/js/Components/Chart.vue`を実行<br>
...
import axios from 'axios';
import { onMounted, reactive } from 'vue';
import Chart from '../Components/Chart.vue' // 追加
...
const barData = reactive({
  labels: ["Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul"], datasets: [
    {
      label: '売上',
      data: [65, 59, 80, 81, 56, 55, 40], backgroundColor: "rgb(75, 192, 192)",
      tension: 0.1,
    }]
})
</script>
